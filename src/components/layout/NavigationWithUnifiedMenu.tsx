...
export default function NavigationWithUnifiedMenu() {
  ...
  return (
    <motion.nav
      ...
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        isScrolled ? 'bg-white/5 backdrop-blur-lg shadow-xl' : 'bg-transparent'
      }`}
    >
                        ...
                        <div className="px-4 mb-3">
                          <div className="flex items-center justify-between p-3 rounded-lg bg-white/5">
                            <div className="flex items-center">
                              <span className="text-white/80 text-sm">Messages & Notifications</span>
                            </div>
                            <UnifiedMenuBadgeMobile />
                          </div>
                          <UnifiedMenu placement="left" />
                        </div>
