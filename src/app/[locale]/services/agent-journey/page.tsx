...
import {
  Eye, Wrench, Activity, CheckCircle, ArrowRight, ArrowLeft,
          ...
          <div className="max-w-6xl mx-auto">
            ...
            >
              <div className="bg-white/[0.03] backdrop-blur-sm border border-white/10 rounded-2xl p-8 max-w-4xl mx-auto">
                ...
                <Link href="/contact?service=agent-journey">
                  <Button
                    size="lg"
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              {[
                { title: t('finalCta.option2.title'), desc: t('finalCta.option2.description'), cta: t('finalCta.option2.cta'), href: '/agent-readiness' },
                { title: t('finalCta.option3.title'), desc: t('finalCta.option3.description'), cta: t('finalCta.option3.cta'), href: '/cases' }
              ].map((option, idx) => (
                <motion.div
                  key={idx}
                  initial={{ opacity: 0, y: 20 }}
