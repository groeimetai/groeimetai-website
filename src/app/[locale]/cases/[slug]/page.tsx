...
const caseDetails: Record<string, CaseDetail> = {
  'enterprise-llm-implementation': {
    ...
    overview: 'Transformed an outdated trigger-based chatbot into an intelligent AI assistant serving 50,000 employees, achieving 85% faster response times and €2.8M annual savings.',
    challenge: {
      title: 'The Challenge',
      points: [
      ...
      phases: [
        {
          ...
          description: 'Analyzed existing system, identified pain points, and designed architecture',
          duration: '2 months'
        },
        {
  ...
  'snelnotuleren-ai-transcription': {
    ...
    overview: 'Built a GDPR-compliant AI transcription platform that processed over 1 million tokens and transcribed 1500+ hours of meetings, serving 500+ active users.',
    challenge: {
      title: 'The Challenge',
      points: [
  ...
  'groeimetai-learning-platform': {
    ...
    industry: 'EdTech',
    duration: '2 weeks',
    overview: 'Revolutionary project where AI agents autonomously built a complete learning platform with 10+ courses, 40+ modules, and blockchain certification in just 2 weeks.',
    challenge: {
      title: 'The Challenge',
      points: [
  ...
  'intelligent-ticket-routing': {
    ...
    industry: 'Financial Services',
    duration: '12 weeks',
    overview: 'Revolutionized ticket routing by implementing a vector database solution that reduced thousands of templates to an intelligent system with 94% routing accuracy.',
    challenge: {
      title: 'The Challenge',
      points: [
  ...
  return (
    <main className="min-h-screen bg-black">
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12">
            <Card className="p-8">
              <h3 className="text-2xl font-bold mb-6 text-white px-4 py-2 inline-block" 
      ...
      <section className="py-20 bg-black/50">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-3xl font-bold text-center mb-12">{caseDetail.implementation.title}</h2>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {caseDetail.results.map((result, index) => (
                <Card key={index} className="p-8 text-center hover-lift">
                  <div className="inline-block px-6 py-3 mb-4 text-4xl font-bold text-white" 
                       style={{background: 'linear-gradient(135deg, #FF6600, #FF8833)'}}>
                    {result.metric}
                  </div>
          ...
          <div className="max-w-6xl mx-auto text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              {caseDetail.technologies.map((tech, index) => (
                <Badge key={index} variant="outline" className="text-lg px-6 py-2 border-orange/30 text-white">
                  {tech}
                </Badge>
              ))}
            </div>
