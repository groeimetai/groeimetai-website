      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <p className="text-xl text-white/70 max-w-3xl mx-auto">
            Traditional AI gives you one perspective. Our orchestrated agents give you an entire team of specialists 
            working in perfect harmony, delivering results that single models simply can&apos;t match.
          </p>
        </motion.div>
