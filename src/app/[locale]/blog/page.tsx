...
export const metadata: Metadata = {
  ...
  description: 'Lees de laatste insights over AI, machine learning, LLM integratie en meer op de GroeimetAI blog.',
  openGraph: {
...
const blogPosts = [
  ...
  },
  {
    ...
    excerpt: 'Hoe AI de ServiceNow platform transformeert en nieuwe mogelijkheden biedt voor service management.',
    content: 'Volledige artikel inhoud...',
    author: 'Tom Jansen',
    date: '2024-03-05',
    readTime: '6 min',
  ...
  },
  {
    ...
    excerpt: 'Essentiële overwegingen voor veilige en compliant LLM implementaties in de Europese markt.',
    content: 'Volledige artikel inhoud...',
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {blogPosts.filter(post => post.featured).map((post) => (
              <Card key={post.id} className="overflow-hidden hover-lift hover:shadow-premium transition-all">
