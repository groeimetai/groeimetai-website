...
const advisoryServices = [
  {
    ...
    description: 'Define your AI vision and create actionable roadmaps that align technology investments with business objectives.',
    icon: Brain,
    slug: 'strategy',
  ...
  },
  {
    ...
    description: 'Navigate complex digital ecosystems with comprehensive transformation strategies focused on optimization.',
    icon: Bot,
    slug: 'transformation',
  ...
  },
  {
    ...
    description: 'Establish responsible AI frameworks that balance innovation with ethics, compliance and security.',
    icon: Shield,
    slug: 'governance',
  ...
  },
  {
    ...
    description: 'Accelerate innovation through strategic pilots and proof-of-concepts that demonstrate clear business value.',
    icon: Sparkles,
    slug: 'innovation',
  ...
  },
  {
    ...
    description: 'Make informed decisions with independent technology assessments and vendor evaluations.',
    icon: Layers,
    slug: 'advisory',
  ...
  },
  {
    ...
    description: 'Ensure successful AI adoption with comprehensive change management and training programs.',
    icon: Workflow,
    slug: 'adoption',
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 text-white">
              Our <span className="text-white px-4 py-2 inline-block" style={{ background: 'linear-gradient(135deg, #FF6600, #FF8833)' }}>Advisory Services</span>
            </h1>
            <p className="text-xl text-white/80 mb-8 max-w-3xl mx-auto">
              Strategic guidance to help leaders navigate AI complexity and unlock transformative business value through intelligent process optimization
            </p>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="space-y-4">
                ...
                <p className="text-white/70">
                  Direct engagement with C-suite leaders to align AI initiatives with business strategy and ensure measurable ROI.
                </p>
              </div>
              ...
              <div className="space-y-4">
                ...
                <p className="text-white/70">
                  Our SPARC framework ensures systematic approach to AI adoption, from strategy to implementation and optimization.
                </p>
              </div>
              ...
              <div className="space-y-4">
                ...
                <p className="text-white/70">
                  Deep understanding of European markets and regulations, with experience across multiple industries.
                </p>
              </div>
              ...
              <div className="space-y-4">
                ...
                <p className="text-white/70">
                  Independent assessments and recommendations focused solely on your business needs and objectives.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link href="/cases">
                <Button size="lg" variant="outline" className="hover-lift border-white/20 text-white hover:bg-white/10 hover:border-orange hover:text-orange">
