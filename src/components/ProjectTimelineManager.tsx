...
export default function ProjectTimelineManager({ quoteId, projectName, onClose }: ProjectTimelineManagerProps) {
            ...
            >
              <div className="flex items-start space-x-4">
                <div className={`p-2 rounded-lg ${
                  stage.status === 'completed' ? 'bg-green/20' : 
                  stage.status === 'current' ? 'bg-orange/20' : 
                  'bg-white/10'
                }`}>
                ...
                <div className="flex-1 space-y-3">
                  <div className="flex items-center justify-between">
                    ...
                    <Select 
                      value={stage.status} 
                      onValueChange={(value) => handleStageStatusChange(stage.id, value as ProjectStage['status'])}
                    >
                  ...
                  {stage.status === 'current' && (
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        onChange={(e) => updateStage(stage.id, { progress: parseInt(e.target.value) || 0 })}
                  ...
                  <div className="flex gap-2">
                    <Input
                      ...
                      onChange={(e) => updateStage(stage.id, { estimatedCompletion: e.target.value })}
                      type="date"
