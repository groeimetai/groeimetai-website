...
export default function TestHeroPage() {
  ...
  useEffect(() => {
    ...
    setDeviceInfo(`${isMobile ? 'Mobile' : 'Desktop'} | Touch: ${hasTouch ? 'Yes' : 'No'} | DPR: ${pixelRatio}`);
    ...
    <div className="relative min-h-screen bg-gradient-to-br from-gray-900 via-blue-900 to-purple-900">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen text-white p-8">
        ...
        <p className="text-xl mb-8 text-center max-w-2xl opacity-90">
          Beweeg je muis over het scherm om de interactieve particle effecten te ervaren.
          Op touch devices, gebruik je vinger om te interageren.
        </p>
        ...
        <div className="grid grid-cols-2 gap-6 text-sm">
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4">
            ...
            <ul className="space-y-1 opacity-80">
              <li>FPS: <span className="font-mono text-green-400">{fps}</span></li>
              <li>Device: <span className="font-mono text-blue-400">{deviceInfo}</span></li>
