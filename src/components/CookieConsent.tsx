            ...
            <div className="relative overflow-hidden rounded-2xl bg-background/95 shadow-2xl backdrop-blur supports-[backdrop-filter]:bg-background/80 border">
                        ...
                        >
                          <div className="space-y-3">
                            ...
                            <div className="flex items-start space-x-3">
                              ...
                              />
                              <div className="flex-1">
                                <label htmlFor="analytics" className="block text-sm font-medium cursor-pointer">
                                  Analytics Cookies
                                </label>
                                <p className="text-sm text-muted-foreground">
                            ...
                            <div className="flex items-start space-x-3">
                              ...
                              />
                              <div className="flex-1">
                                <label htmlFor="marketing" className="block text-sm font-medium cursor-pointer">
                                  Marketing Cookies
                                </label>
                                <p className="text-sm text-muted-foreground">
                            ...
                            <div className="flex items-start space-x-3">
                              ...
                              />
                              <div className="flex-1">
                                <label htmlFor="functional" className="block text-sm font-medium cursor-pointer">
                                  Functional Cookies
                                </label>
                                <p className="text-sm text-muted-foreground">
              ...
              <div className="border-t bg-muted/50 px-6 py-3 sm:px-8">
                <div className="flex items-center space-x-2 text-xs text-muted-foreground">
                  ...
                  <span>Your privacy is important to us. We comply with GDPR and CCPA regulations.</span>
                </div>
              </div>
            </div>
          </div>
