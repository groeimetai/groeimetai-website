              ...
              <div className="flex-1">
                ...
                <div className="grid grid-cols-1 gap-2 text-sm text-white/90">
                  <div className="flex items-center space-x-2">
                    ...
                    <span>{t('results.questions.0', { count: score >= 70 ? '2-3 systems' : score >= 50 ? '5+ systems' : '10+ systems' })}</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <span className="text-orange-400">❓</span>
          ...
          <div className="bg-gradient-to-r from-white/5 to-white/10 rounded-lg p-4">
            <div className="flex items-center space-x-3 mb-2">
              ...
              <p className="text-white font-semibold text-sm">
                {t('results.benefits.0')}
              </p>
            </div>
            <p className="text-white/70 text-sm ml-9">
              {t('results.benefits.1')}
            </p>
          </div>
        </div>
      </motion.div>
        ...
        <div className="bg-gradient-to-r from-orange-500/20 to-orange-600/20 p-6 border-b border-white/10">
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="text-right">
              <div className="text-white/60 text-sm">{t('step')} {currentStep} {t('of')} {totalSteps}</div>
        ...
        <div className="p-6">
          <AnimatePresence mode="wait">
                ...
                >
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    <div className="flex items-center space-x-3">
                      ...
                      <Label htmlFor="q1-most" className="text-white/80">{t('questions.apis.options.most')}</Label>
                    </div>
                    <div className="flex items-center space-x-3">
                      <RadioGroupItem value="some" id="q1-some" />
                      <Label htmlFor="q1-some" className="text-white/80">{t('questions.apis.options.some')}</Label>
                    </div>
                    <div className="flex items-center space-x-3">
                      <RadioGroupItem value="unknown" id="q1-unknown" />
                      <Label htmlFor="q1-unknown" className="text-white/80">{t('questions.apis.options.unknown')}</Label>
                    </div>
                    <div className="flex items-center space-x-3">
                      <RadioGroupItem value="none" id="q1-none" />
                      <Label htmlFor="q1-none" className="text-white/80">{t('questions.apis.options.none')}</Label>
                    </div>
                  </div>
                </RadioGroup>
              </motion.div>
                ...
                >
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    <div className="flex items-center space-x-3">
                      ...
                      <Label htmlFor="q2-instant" className="text-white/80">{t('questions.dataAccess.options.instant')}</Label>
                    </div>
                    <div className="flex items-center space-x-3">
                      <RadioGroupItem value="minutes" id="q2-minutes" />
                      <Label htmlFor="q2-minutes" className="text-white/80">{t('questions.dataAccess.options.minutes')}</Label>
                    </div>
                    <div className="flex items-center space-x-3">
                      <RadioGroupItem value="difficult" id="q2-difficult" />
                      <Label htmlFor="q2-difficult" className="text-white/80">{t('questions.dataAccess.options.difficult')}</Label>
                    </div>
                    <div className="flex items-center space-x-3">
                      <RadioGroupItem value="impossible" id="q2-impossible" />
                      <Label htmlFor="q2-impossible" className="text-white/80">{t('questions.dataAccess.options.impossible')}</Label>
                    </div>
                  </div>
                </RadioGroup>
              </motion.div>
                ...
                >
                  <div className="space-y-3">
                    <div className="flex items-center space-x-3">
                      ...
                      <Label htmlFor="q3-enterprise" className="text-white/80">{t('questions.budget.options.enterprise')}</Label>
                    </div>
                    <div className="flex items-center space-x-3">
                      <RadioGroupItem value="EUR25-100k - Meerdere systemen" id="q3-multiple" />
                      <Label htmlFor="q3-multiple" className="text-white/80">{t('questions.budget.options.multiple')}</Label>
                    </div>
                    <div className="flex items-center space-x-3">
                      <RadioGroupItem value="EUR10-25k - Één systeem serieus" id="q3-single" />
                      <Label htmlFor="q3-single" className="text-white/80">{t('questions.budget.options.single')}</Label>
                    </div>
                    <div className="flex items-center space-x-3">
                      <RadioGroupItem value="< EUR10k - Pilot/experiment" id="q3-pilot" />
                      <Label htmlFor="q3-pilot" className="text-white/80">{t('questions.budget.options.pilot')}</Label>
                    </div>
                    <div className="flex items-center space-x-3">
                      <RadioGroupItem value="Eerst business case nodig" id="q3-business-case" />
                      <Label htmlFor="q3-business-case" className="text-white/80">{t('questions.budget.options.businessCase')}</Label>
                    </div>
                  </div>
                </RadioGroup>
              </motion.div>
                ...
                >
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    <div className="flex items-center space-x-3">
                      ...
                      <Label htmlFor="q4-knowledge" className="text-white/80">{t('questions.blocker.options.knowledge')}</Label>
                    </div>
                    <div className="flex items-center space-x-3">
                      <RadioGroupItem value="Systemen praten niet met elkaar" id="q4-integration" />
                      <Label htmlFor="q4-integration" className="text-white/80">{t('questions.blocker.options.integration')}</Label>
                    </div>
                    <div className="flex items-center space-x-3">
                      <RadioGroupItem value="Geen idee waar te beginnen" id="q4-guidance" />
                      <Label htmlFor="q4-guidance" className="text-white/80">{t('questions.blocker.options.guidance')}</Label>
                    </div>
                    <div className="flex items-center space-x-3">
                      <RadioGroupItem value="Budget/resources beperkt" id="q4-budget" />
                      <Label htmlFor="q4-budget" className="text-white/80">{t('questions.blocker.options.budget')}</Label>
                    </div>
                    <div className="flex items-center space-x-3">
                      <RadioGroupItem value="Security/compliance zorgen" id="q4-security" />
                      <Label htmlFor="q4-security" className="text-white/80">{t('questions.blocker.options.security')}</Label>
                    </div>
                    <div className="flex items-center space-x-3">
                      <RadioGroupItem value="Team weerstand tegen verandering" id="q4-resistance" />
                      <Label htmlFor="q4-resistance" className="text-white/80">{t('questions.blocker.options.resistance')}</Label>
                    </div>
                    <div className="flex items-center space-x-3">
                      <RadioGroupItem value="Data is te rommelig/verspreid" id="q4-data" />
                      <Label htmlFor="q4-data" className="text-white/80">{t('questions.blocker.options.data')}</Label>
                    </div>
                    <div className="flex items-center space-x-3">
                      <RadioGroupItem value="Anders" id="q4-other" />
                      <Label htmlFor="q4-other" className="text-white/80">{t('questions.blocker.options.other')}</Label>
                    </div>
                  </div>
                </RadioGroup>
              </motion.div>
            ...
            {currentStep === 5 && (
              ...
              >
                <h4 className="text-xl font-bold text-white mb-4">
                  {t('questions.impact.title')}
                </h4>
                <p className="text-white/60 text-sm mb-4">
                  {t('questions.impact.subtitle')}
                </p>
                <RadioGroup 
                ...
                >
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    <div className="flex items-center space-x-3">
                      ...
                      <Label htmlFor="q5-helpdesk" className="text-white/80">{t('questions.impact.options.helpdesk')}</Label>
                    </div>
                    <div className="flex items-center space-x-3">
                      <RadioGroupItem value="CRM/Sales" id="q5-crm" />
                      <Label htmlFor="q5-crm" className="text-white/80">{t('questions.impact.options.crm')}</Label>
                    </div>
                    <div className="flex items-center space-x-3">
                      <RadioGroupItem value="ERP/Finance" id="q5-erp" />
                      <Label htmlFor="q5-erp" className="text-white/80">{t('questions.impact.options.erp')}</Label>
                    </div>
                    <div className="flex items-center space-x-3">
                      <RadioGroupItem value="Planning/Logistics" id="q5-planning" />
                      <Label htmlFor="q5-planning" className="text-white/80">{t('questions.impact.options.planning')}</Label>
                    </div>
                    <div className="flex items-center space-x-3">
                      <RadioGroupItem value="Kennisbank/Documentatie" id="q5-knowledge" />
                      <Label htmlFor="q5-knowledge" className="text-white/80">{t('questions.impact.options.knowledge')}</Label>
                    </div>
                    <div className="flex items-center space-x-3">
                      <RadioGroupItem value="HR/Personeelszaken" id="q5-hr" />
                      <Label htmlFor="q5-hr" className="text-white/80">{t('questions.impact.options.hr')}</Label>
                    </div>
                    <div className="flex items-center space-x-3">
                      <RadioGroupItem value="Eigen software/Maatwerk" id="q5-custom" />
                      <Label htmlFor="q5-custom" className="text-white/80">{t('questions.impact.options.custom')}</Label>
                    </div>
                    <div className="flex items-center space-x-3">
                      <RadioGroupItem value="Anders" id="q5-other" />
                      <Label htmlFor="q5-other" className="text-white/80">{t('questions.impact.options.other')}</Label>
                    </div>
                  </div>
                </RadioGroup>
              </motion.div>
