...
export const userValidation = {
  ...
  register: {
    body: Joi.object({
      ...
      role: Joi.string().valid('client', 'consultant').default('client').messages({
  ...
  updateProfile: {
    body: Joi.object({
      ...
      profile: Joi.object({
        ...
        experience: Joi.string().max(1000).trim().optional(),
      ...
      preferences: Joi.object({
        ...
        language: Joi.string().valid('en', 'es', 'fr', 'de', 'pt', 'nl').optional(),
  ...
  listUsers: {
    query: Joi.object({
      ...
      role: Joi.string().valid('client', 'consultant', 'admin').optional(),
