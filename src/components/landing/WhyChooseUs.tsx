          ...
          {differentiators.map((item, index) => {
            ...
            return (
              <motion.div
                ...
                className="group"
              >
                <div className="bg-black/50 backdrop-blur-sm border border-white/10 rounded-2xl p-8 h-full
                  ...
                  {/* Content */}
                  <h3 className="text-xl font-bold mb-3 text-white">{t(`differentiators.${item.key}.title`)}</h3>
                  <p className="text-white/70 mb-4">{t(`differentiators.${item.key}.description`)}</p>
                  
                  {/* Metric */}
                  <div className="pt-4 border-t border-white/10">
                    <p className="text-lg font-semibold text-orange">{t(`differentiators.${item.key}.metric`)}</p>
                  </div>
                </div>
              </motion.div>
            );
