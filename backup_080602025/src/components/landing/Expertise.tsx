        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          {expertiseAreas.map((area, index) => {
            ...
            return (
              ...
              >
                <div
                  className="relative bg-black/50 backdrop-blur-sm border border-white/10 rounded-2xl p-8 h-full
                  transition-all duration-300 hover:border-orange-500/50 hover:shadow-2xl hover:scale-[1.02]"
                >
                  {/* Icon */}
                  <div
                    className={`inline-flex p-3 rounded-xl bg-gradient-to-br ${area.color} mb-6`}
                  >
